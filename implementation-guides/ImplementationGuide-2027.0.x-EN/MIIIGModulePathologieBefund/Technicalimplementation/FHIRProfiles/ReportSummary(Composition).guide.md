...
This profile is the first entry in a Bundle of `Bundle.type` "document"; the structure and signature of the Bundle are described in the **MII PR Patho Bundle** profile.
