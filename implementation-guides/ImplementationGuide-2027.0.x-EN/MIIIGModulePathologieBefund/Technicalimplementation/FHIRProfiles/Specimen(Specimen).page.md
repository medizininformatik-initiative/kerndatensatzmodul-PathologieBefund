...
Specimens are referenced in various profiles. In the **MII PR Patho Report** and in the findings of the groupers for Macroscopy and Diagnostic Conclusion, the specimens of the submission (parts) should be referenced; in the findings of the Microscopy grouper, the specimens at the stained tissue section level should be referenced.
