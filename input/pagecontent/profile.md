...
Für verpflichtende oder als must-support markierte Elemente gelten die entsprechenden [Regeln der IPS](http://hl7.org/fhir/uv/ips/design.html#must-support), die auch für diesen Implementation Guide gelten.
