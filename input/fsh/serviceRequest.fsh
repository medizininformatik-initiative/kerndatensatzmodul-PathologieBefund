...
//------------------------------------
// MII_PR_Patho_Request_Group
//------------------------------------
Profile: MII_PR_Patho_Request_Group
Parent: RequestGroup
Id: mii-pr-patho-request-group
Title: "MII PR Patho Request Group"
Description: "Profile to group multiple pathology service requests into a single request group."
* insert PR_CS_VS_Version
* insert Publisher
* insert Translation(^title, de-DE, MII PR Patho Auftragsgruppe)
* insert Translation(^title, en-US, MII PR Patho Request Group)
* insert Translation(^description, de-DE, Profil zur Gruppierung mehrerer pathologischer Untersuchungsaufträge in einer Auftragsgruppe)
* insert Translation(^description, en-US, Profile to group multiple pathology service requests into a single request group)
// Meta
* meta.profile MS
// Status
* status MS
* insert Label(status, Status, Status der Auftragsgruppe)
* insert Translation(status ^short, de-DE, Status)
* insert Translation(status ^short, en-US, Status)
* insert Translation(status ^definition, de-DE, Status der Auftragsgruppe)
* insert Translation(status ^definition, en-US, Status of the request group)
// Intent
* intent MS
* insert Label(intent, Absicht, Absicht der Auftragsgruppe)
* insert Translation(intent ^short, de-DE, Absicht)
* insert Translation(intent ^short, en-US, Intent)
* insert Translation(intent ^definition, de-DE, Absicht der Auftragsgruppe)
...
// AuthoredOn
* authoredOn MS
* insert Label(authoredOn, Erstellt am, Datum der Erstellung der Auftragsgruppe)
* insert Translation(authoredOn ^short, de-DE, Erstellt am)
* insert Translation(authoredOn ^short, en-US, Authored on)
* insert Translation(authoredOn ^definition, de-DE, Datum der Erstellung der Auftragsgruppe)
* insert Translation(authoredOn ^definition, en-US, Date the request group was authored)
// Author
* author MS
* insert Label(author, Autor, Person oder Organisation die die Auftragsgruppe erstellt hat)
* insert Translation(author ^short, de-DE, Autor)
* insert Translation(author ^short, en-US, Author)
* insert Translation(author ^definition, de-DE, Person oder Organisation die die Auftragsgruppe erstellt hat)
* insert Translation(author ^definition, en-US, Person or organization who authored the request group)
* author only Reference(Practitioner or Organization)
// Action
* action 1..* MS
* insert Label(action, Aktion, Einzelne Aufträge innerhalb der Auftragsgruppe)
* insert Translation(action ^short, de-DE, Aktion)
* insert Translation(action ^short, en-US, Action)
* insert Translation(action ^definition, de-DE, Einzelne Aufträge innerhalb der Auftragsgruppe)
* insert Translation(action ^definition, en-US, Individual requests within the request group)
  * resource 1..1 MS
  * insert Label(resource, Auftrag, Verweis auf den einzelnen Untersuchungsauftrag)
  * insert Translation(resource ^short, de-DE, Auftrag)
  * insert Translation(resource ^short, en-US, Resource)
  * insert Translation(resource ^definition, de-DE, Verweis auf den einzelnen Untersuchungsauftrag)
  * insert Translation(resource ^definition, en-US, Reference to the individual service request)
  * resource only Reference(mii-pr-patho-service-request)

//---------------------------
// RequestGroup Example
//---------------------------
Instance: mii-exa-patho-request-group
InstanceOf: mii-pr-patho-request-group
Usage: #example
Title: "MII EXA Patho Request Group"
Description: "Example of a pathology request group combining multiple service requests"
* meta.profile = "https://www.medizininformatik-initiative.de/fhir/ext/modul-patho/StructureDefinition/mii-pr-patho-request-group"
* status = #active
* intent = #order
* subject = Reference(Patient/12345)
* encounter = Reference(Encounter/87687)
* authoredOn = "2021-06-01"
* author = Reference(Practitioner/34456)
* action[+].resource = Reference(ServiceRequest/mii-exa-patho-request)
...
InstanceOf: mii-pr-patho-service-request
Usage: #example
* meta.profile = "https://www.medizininformatik-initiative.de/fhir/ext/modul-patho/StructureDefinition/mii-pr-patho-service-request|2027.0.0"
...
* meta.profile = "https://www.medizininformatik-initiative.de/fhir/ext/modul-patho/StructureDefinition/mii-pr-patho-problem-list-item|2027.0.0"
* category[problem-list-item] = $cs-hl7-condition-category#problem-list-item
...
* meta.profile = "https://www.medizininformatik-initiative.de/fhir/ext/modul-patho/StructureDefinition/mii-pr-patho-history-of-present-illness|2027.0.0"
* status = #current 
* mode = #snapshot
...
* meta.profile = "https://www.medizininformatik-initiative.de/fhir/ext/modul-patho/StructureDefinition/mii-pr-patho-active-problems-list|2027.0.0"
* status = #current 
* mode = #snapshot
