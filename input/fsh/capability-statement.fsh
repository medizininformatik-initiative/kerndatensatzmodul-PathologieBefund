...
* rest.resource[+]
  ...
  * insert AddSupportedProfile(mii-pr-patho-specimen|2027.0.0-ballot.rc2, #SHALL)
...
* rest.resource[+]
  ...
  * insert AddSupportedProfile(mii-pr-patho-intraoperative-grouper|2027.0.0-ballot.rc2, #SHALL)
  * insert AddSupportedProfile(mii-pr-patho-macroscopic-grouper|2027.0.0-ballot.rc2, #SHALL)
  * insert AddSupportedProfile(mii-pr-patho-microscopic-grouper|2027.0.0-ballot.rc2, #SHALL)
  * insert AddSupportedProfile(mii-pr-patho-finding|2027.0.0-ballot.rc2, #SHALL)
  * insert AddSupportedProfile(mii-pr-patho-diagnostic-conclusion-grouper|2027.0.0-ballot.rc2, #SHALL)
  // * insert AddSupportedProfile(mii-pr-patho-section-grouper, #SHALL)
  * insert AddSupportedProfile(mii-pr-patho-additional-specified-grouper|2027.0.0-ballot.rc2, #SHALL)
  * insert AddInteraction(#read, #SHALL)
  * insert AddInteraction(#search-type, #SHALL)
  // CORE
  * insert AddSearchParameter(#SHALL, "_id", Resource-id, #token, "Logical id of this artifact")
...
* rest.resource[+]
  ...
  * insert AddSupportedProfile(mii-pr-patho-service-request|2027.0.0-ballot.rc2, #SHALL)
  * insert AddInteraction(#read, #SHALL)
  * insert AddInteraction(#search-type, #SHALL)
  // CORE
  * insert AddSearchParameter(#SHALL, "_id", Resource-id, #token, "Logical id of this artifact")
...
* rest.resource[+]
  ...
  * insert AddSupportedProfile(mii-pr-patho-report|2027.0.0-ballot.rc2, #SHALL)
  * insert AddInteraction(#read, #SHALL)
  * insert AddInteraction(#search-type, #SHALL)
  // CORE
  * insert AddSearchParameter(#SHALL, "_id", Resource-id, #token, "Logical id of this artifact")
...
* rest.resource[+]
  ...
  * insert AddSupportedProfile(mii-pr-patho-composition|2027.0.0-ballot.rc2, #SHALL)
  * insert AddInteraction(#read, #SHALL)
  * insert AddInteraction(#search-type, #SHALL)
  // CORE
  * insert AddSearchParameter(#SHALL, "_id", Resource-id, #token, "Logical id of this artifact")
...
* rest.resource[+]
  ...
  * insert AddSupportedProfile(mii-pr-patho-attached-image|2027.0.0-ballot.rc2, #SHALL)
  * insert AddInteraction(#read, #SHALL)
  * insert AddInteraction(#search-type, #SHALL)
  // CORE
  * insert AddSearchParameter(#SHALL, "_id", Resource-id, #token, "Logical id of this artifact")
