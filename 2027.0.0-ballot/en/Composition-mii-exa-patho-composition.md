# Pathology Report - MII IG Modul Patho v2027.0.0-ballot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Pathology Report**

## Example Composition: Pathology Report
...
Profile: [MII PR Patho Composition](StructureDefinition-mii-pr-patho-composition.md) version: 2027.0.0-ballot
...
```json
{
  ...
  "meta" : {
    "profile" : ["https://www.medizininformatik-initiative.de/fhir/ext/modul-patho/StructureDefinition/mii-pr-patho-composition|2027.0.0-ballot"]
  },
  "extension" : [{
