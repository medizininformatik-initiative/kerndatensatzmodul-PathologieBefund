# MII PR Patho Report - MII IG Modul Patho v2027.0.0-ballot

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **MII PR Patho Report**

## Resource Profile: MII PR Patho Report 

| | |
| :--- | :--- |
| *Official URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-patho/StructureDefinition/mii-pr-patho-report | *Version*:2027.0.0-ballot |
| Active as of 2026-09-14 | *Computable Name*:MII_PR_Patho_Report |
...
As an entry in the "patho-diagnostic-report" section of the [MII PR Patho Composition](StructureDefinition-mii-pr-patho-composition.md) profile, the **MII PR Patho Report** forms the core of a persistent document "pathology report". 
-------
...
Other representations of profile: [CSV](../StructureDefinition-mii-pr-patho-report.csv), [Excel](../StructureDefinition-mii-pr-patho-report.xlsx), [Schematron](../StructureDefinition-mii-pr-patho-report.sch) 
