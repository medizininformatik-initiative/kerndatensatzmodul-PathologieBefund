# MII PR Patho Intraoperative Grouper - MII IG Modul Patho v2027.0.0-ballot.rc2

* [**Table of Contents**](toc.md)
* [**Artefaktübersicht**](artifacts.md)
* **MII PR Patho Intraoperative Grouper**

## Ressourcenprofil: MII PR Patho Intraoperative Grouper 

| | |
| :--- | :--- |
| *Offizielle URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-patho/StructureDefinition/mii-pr-patho-intraoperative-grouper | *Version*:2027.0.0-ballot.rc2 |
| Active Stand: 2026-09-08 | *Maschinenlesbarer Name*:MII_PR_Patho_Intraoperative_Grouper |

 
Das Profil **MII PR Patho Intraoperative Grouper** der Resource Observation stellt als `DiagnosticReport.result:intraoperative-grouper` für einen [MII PR Patho Report](StructureDefinition-mii-pr-patho-report.md) den jeweiligen Beobachtungsberichtsabschnitt "Intraoperative Beobachtung" (entspr. dieser CDA-Section) dar und fungiert als Organizer für die entsprechenden Gruppierungen von [MII PR Patho Finding](StructureDefinition-mii-pr-patho-finding.md). 
...
You can also check for [usages in the FHIR IG Statistics](https://packages2.fhir.org/xig/resource/de.medizininformatikinitiative.kerndatensatz.patho|current/StructureDefinition/StructureDefinition-mii-pr-patho-intraoperative-grouper.json)
...
Weitere Repräsentationen des Profils: [CSV](../StructureDefinition-mii-pr-patho-intraoperative-grouper.csv), [Excel](../StructureDefinition-mii-pr-patho-intraoperative-grouper.xlsx), [Schematron](../StructureDefinition-mii-pr-patho-intraoperative-grouper.sch) 
...
```json
{
  ...
  "url" : "https://www.medizininformatik-initiative.de/fhir/ext/modul-patho/StructureDefinition/mii-pr-patho-intraoperative-grouper",
  "version" : "2027.0.0-ballot.rc2",
  "name" : "MII_PR_Patho_Intraoperative_Grouper",
  "_name" : {
    "extension" : [{
      "extension" : [{
        "url" : "lang",
      ...
      {
        "url" : "content",
        "valueString" : "MII_PR_Patho_Intraoperative_Grouper"
      }],
