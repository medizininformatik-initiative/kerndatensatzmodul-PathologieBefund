# MII PR Patho Bundle - MII IG Modul Patho v2027.0.0-ballot.rc2

* [**Table of Contents**](toc.md)
* [**Artefaktübersicht**](artifacts.md)
* **MII PR Patho Bundle**

## Ressourcenprofil: MII PR Patho Bundle 

| | |
| :--- | :--- |
| *Offizielle URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-patho/StructureDefinition/mii-pr-patho-bundle | *Version*:2027.0.0-ballot.rc2 |
| Active Stand: 2026-09-08 | *Maschinenlesbarer Name*:MII_PR_Patho_Bundle |

 
Dieses Profil **MII PR Patho Bundle** erbt von [Profile - ISiK - BerichtSubsysteme](https://simplifier.net/isik-stufe-5/isikberichtbundle) aus der Spezifikation [ISiK - Stufe 5](https://simplifier.net/isik-stufe-5). Es dient der Aggregation aller Ressourcen, die Bestandteil des Dokumentes sind. Dabei sollte die erste Ressource im Bundle (Bundle.entry.resource) stets eine Composition sein. 
...
Diese Struktur ist abgeleitet von [ISiKBerichtBundle](https://simplifier.net/resolve?scope=de.gematik.isik@5.1.2&canonical=https://gematik.de/fhir/isik/StructureDefinition/ISiKBerichtBundle) 
...
* [MII PR Patho Base Observation (https://www.medizininformatik-initiative.de/fhir/ext/modul-patho/StructureDefinition/mii-pr-patho-base-observation)](StructureDefinition-mii-pr-patho-base-observation.md)
...
Weitere Repräsentationen des Profils: [CSV](../StructureDefinition-mii-pr-patho-bundle.csv), [Excel](../StructureDefinition-mii-pr-patho-bundle.xlsx), [Schematron](../StructureDefinition-mii-pr-patho-bundle.sch) 
