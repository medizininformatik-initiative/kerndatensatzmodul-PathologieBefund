# MII PR Patho Section Grouper - MII IG Modul Patho v2027.0.0-ballot.rc2

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **MII PR Patho Section Grouper**

## Resource Profile: MII PR Patho Section Grouper ( Abstract ) 

| | |
| :--- | :--- |
| *Official URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-patho/StructureDefinition/mii-pr-patho-section-grouper | *Version*:2027.0.0-ballot.rc2 |
| Active as of 2026-09-08 | *Computable Name*:MII_PR_Patho_Section_Grouper |
...
Other representations of profile: [CSV](../StructureDefinition-mii-pr-patho-section-grouper.csv), [Excel](../StructureDefinition-mii-pr-patho-section-grouper.xlsx), [Schematron](../StructureDefinition-mii-pr-patho-section-grouper.sch) 
