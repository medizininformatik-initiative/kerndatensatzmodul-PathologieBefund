# MII EXA Patho Active Problems List - MII IG Modul Patho v2027.0.0-ballot.rc2
...
Profile: [MII PR Patho Active Problems List](StructureDefinition-mii-pr-patho-active-problems-list.md) version: 2027.0.0-ballot.rc2
...
```json
{
  ...
  "meta" : {
    "profile" : ["https://www.medizininformatik-initiative.de/fhir/ext/modul-patho/StructureDefinition/mii-pr-patho-active-problems-list|2027.0.0-ballot.rc2"]
  },
  "status" : "current",
  "mode" : "snapshot",
  "code" : {
