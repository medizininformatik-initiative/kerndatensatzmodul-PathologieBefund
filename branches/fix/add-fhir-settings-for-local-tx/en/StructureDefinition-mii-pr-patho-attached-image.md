# MII PR Patho Attached Image - MII IG Modul Patho v2027.0.0-ballot.rc2

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **MII PR Patho Attached Image**

## Resource Profile: MII PR Patho Attached Image 

| | |
| :--- | :--- |
| *Official URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-patho/StructureDefinition/mii-pr-patho-attached-image | *Version*:2027.0.0-ballot.rc2 |
| Active as of 2026-09-08 | *Computable Name*:MII_PR_Patho_Attached_Image |

 
The **MII PR Patho Attached Image** profile of the Media resource is used to describe images embedded in the report, i.e. the [MII PR Patho Report](StructureDefinition-mii-pr-patho-report.md). To include images in [MII PR Patho Finding](StructureDefinition-mii-pr-patho-finding.md), a reference to an ImagingStudy must be used. The present profile should preferably only be used for the "illustration" of a pathology report. 
...
Other representations of profile: [CSV](../StructureDefinition-mii-pr-patho-attached-image.csv), [Excel](../StructureDefinition-mii-pr-patho-attached-image.xlsx), [Schematron](../StructureDefinition-mii-pr-patho-attached-image.sch) 
