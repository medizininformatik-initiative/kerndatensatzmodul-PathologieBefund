# mii-exa-patho-request - MII IG Modul Patho v2027.0.0-ballot.rc2

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **mii-exa-patho-request**

## Example ServiceRequest: mii-exa-patho-request
...
Profile: [MII PR Patho Service Request](StructureDefinition-mii-pr-patho-service-request.md) version: 2027.0.0-ballot.rc2
...
```json
{
  ...
  "meta" : {
    "profile" : ["https://www.medizininformatik-initiative.de/fhir/ext/modul-patho/StructureDefinition/mii-pr-patho-service-request|2027.0.0-ballot.rc2"]
  },
  "identifier" : [{
    "type" : {
      "coding" : [{
