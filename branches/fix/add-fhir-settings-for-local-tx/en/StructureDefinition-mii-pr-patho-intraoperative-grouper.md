...
## Resource Profile: MII PR Patho Intraoperative Grouper 

| | |
| :--- | :--- |
| *Official URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-patho/StructureDefinition/mii-pr-patho-intraoperative-grouper | *Version*:2027.0.0-ballot.rc2 |
| Active as of 2026-09-08 | *Computable Name*:MII_PR_Patho_Intraoperative_Grouper |

 
The **MII PR Patho Intraoperative Grouper** profile of the Observation resource represents, as `DiagnosticReport.result:intraoperative-grouper` for a [MII PR Patho Report](StructureDefinition-mii-pr-patho-report.md), the respective observation report section "Intraoperative Observation" (corresponding to this CDA section) and acts as an organizer for the corresponding groupings of [MII PR Patho Finding](StructureDefinition-mii-pr-patho-finding.md). 
...
Other representations of profile: [CSV](../StructureDefinition-mii-pr-patho-intraoperative-grouper.csv), [Excel](../StructureDefinition-mii-pr-patho-intraoperative-grouper.xlsx), [Schematron](../StructureDefinition-mii-pr-patho-intraoperative-grouper.sch) 
