...
## Resource Profile: MII PR Patho Finding 

| | |
| :--- | :--- |
| *Official URL*:https://www.medizininformatik-initiative.de/fhir/ext/modul-patho/StructureDefinition/mii-pr-patho-finding | *Version*:2027.0.0-ballot.rc2 |
| Active as of 2026-09-08 | *Computable Name*:MII_PR_Patho_Finding |
...
**Special case:** 
* In the case of a **report update**, a **MII PR Patho Finding** with the LOINC code [90004-3 - Clinical significance of updated information](https://loinc.org/90004-3/) serves as an organizer for the update information represented in the [MII PR Patho Diagnostic Conclusion Grouper](StructureDefinition-mii-pr-patho-diagnostic-conclusion-grouper.md). The focus reference is used to point to the affected **MII PR Patho Grouper** (observation section). The `Observation.value` is represented by a "ClinicalSignificance" value set (e.g. LOINC LL4770-5).
...
Further extensive examples with complete narratives can be found in the [Prostate Cancer Spec IG](https://bih-cei.github.io/ProstateCancerSpec/index.html).
...
Other representations of profile: [CSV](../StructureDefinition-mii-pr-patho-finding.csv), [Excel](../StructureDefinition-mii-pr-patho-finding.xlsx), [Schematron](../StructureDefinition-mii-pr-patho-finding.sch) 
