# MII EXA Patho History Of Present Illness - MII IG Modul Patho v2027.0.0-ballot.rc2

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **MII EXA Patho History Of Present Illness**

## Example List: MII EXA Patho History Of Present Illness
...
Profile: [MII PR Patho History Of Present Illness](StructureDefinition-mii-pr-patho-history-of-present-illness.md) version: 2027.0.0-ballot.rc2
...
```json
{
  ...
  "meta" : {
    "profile" : ["https://www.medizininformatik-initiative.de/fhir/ext/modul-patho/StructureDefinition/mii-pr-patho-history-of-present-illness|2027.0.0-ballot.rc2"]
  },
  "status" : "current",
  "mode" : "snapshot",
  "code" : {
