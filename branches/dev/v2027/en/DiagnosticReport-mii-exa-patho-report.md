# mii-exa-patho-report - MII IG Modul Patho v2027.0.0-ballot.rc2

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **mii-exa-patho-report**

## Example DiagnosticReport: mii-exa-patho-report
...
Profile: [MII PR Patho Report](StructureDefinition-mii-pr-patho-report.md) version: 2027.0.0-ballot.rc2
...
Well-differentiated acinar adenocarcinoma of the prostate, ISUP grade group 1
...
```json
{
  ...
  "meta" : {
    "profile" : ["https://www.medizininformatik-initiative.de/fhir/ext/modul-patho/StructureDefinition/mii-pr-patho-report|2027.0.0-ballot.rc2"]
  },
  "identifier" : [{
    "type" : {
      "coding" : [{
