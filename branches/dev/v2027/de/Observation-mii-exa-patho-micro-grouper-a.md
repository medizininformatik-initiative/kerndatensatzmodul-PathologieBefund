# mii-exa-patho-micro-grouper-a - MII IG Modul Patho v2027.0.0-ballot

* [**Table of Contents**](toc.md)
* [**Artefaktübersicht**](artifacts.md)
* **mii-exa-patho-micro-grouper-a**

## Beispiel Observation: mii-exa-patho-micro-grouper-a
...
Profile: [MII PR Patho Microscopic Grouper](StructureDefinition-mii-pr-patho-microscopic-grouper.md) version: 2027.0.0-ballot
...
```json
{
  ...
  "meta" : {
    "profile" : ["https://www.medizininformatik-initiative.de/fhir/ext/modul-patho/StructureDefinition/mii-pr-patho-microscopic-grouper|2027.0.0-ballot"]
  },
  "status" : "final",
  "category" : [{
    "coding" : [{
