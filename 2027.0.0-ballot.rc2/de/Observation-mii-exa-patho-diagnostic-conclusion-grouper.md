# mii-exa-patho-diagnostic-conclusion-grouper - MII IG Modul Patho v2027.0.0-ballot.rc2

* [**Table of Contents**](toc.md)
* [**Artefaktübersicht**](artifacts.md)
* **mii-exa-patho-diagnostic-conclusion-grouper**

## Beispiel Observation: mii-exa-patho-diagnostic-conclusion-grouper
...
Profile: [MII PR Patho Diagnostic Conclusion Grouper](StructureDefinition-mii-pr-patho-diagnostic-conclusion-grouper.md) version: 2027.0.0-ballot.rc2
...
```json
{
  ...
  "meta" : {
    "profile" : ["https://www.medizininformatik-initiative.de/fhir/ext/modul-patho/StructureDefinition/mii-pr-patho-diagnostic-conclusion-grouper|2027.0.0-ballot.rc2"]
  },
  "status" : "final",
  "category" : [{
    "coding" : [{
